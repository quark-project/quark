...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Quark is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Quark is downloading blocks...");
    ...
    result.push_back(Pair("masternode_payments", chainActive.Tip()->nHeight > Params().FirstMasternodePaymentBlock()));
